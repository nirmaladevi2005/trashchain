  ...
  return (
    <div className="min-h-screen bg-[#F6F8F5] dark:bg-[#0A0F0D] text-[#0F172A] dark:text-[#F8FAFC] py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-200">
      <div className="max-w-5xl mx-auto space-y-20">
        ...
        <ScrollReveal variant="fade-up" className="text-center space-y-6 pt-4">
          <Badge variant="success" className="bg-emerald-500/10 text-emerald-800 dark:text-emerald-300 border-emerald-500/30 text-xs font-mono px-3 py-1">
          ...
          <p className="text-base sm:text-lg text-[#64748B] dark:text-[#94A3B8] max-w-2xl mx-auto leading-relaxed font-sans">
        ...
        <ScrollReveal variant="fade-up" className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-3xl p-8 sm:p-10 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 text-center font-mono text-xs">
            <div className="p-4 bg-rose-500/5 dark:bg-rose-950/20 border border-rose-500/20 rounded-2xl space-y-2">
            ...
            <div className="p-4 bg-amber-500/5 dark:bg-amber-950/20 border border-amber-500/20 rounded-2xl space-y-2">
            ...
            <div className="p-4 bg-purple-500/5 dark:bg-purple-950/20 border border-purple-500/20 rounded-2xl space-y-2">
            ...
            <div className="p-4 bg-blue-500/5 dark:bg-blue-950/20 border border-blue-500/20 rounded-2xl space-y-2">
        ...
        <div className="space-y-10">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <StaggerItem>
              <div className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-2xl p-6 space-y-3 shadow-sm hover:border-emerald-500/40 transition-colors">
            ...
            <StaggerItem>
              <div className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-2xl p-6 space-y-3 shadow-sm hover:border-purple-500/40 transition-colors">
                <div className="flex items-center justify-between">
            ...
            <StaggerItem>
              <div className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-2xl p-6 space-y-3 shadow-sm hover:border-indigo-500/40 transition-colors">
                <div className="flex items-center justify-between">
            ...
            <StaggerItem>
              <div className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-2xl p-6 space-y-3 shadow-sm hover:border-amber-500/40 transition-colors">
                <div className="flex items-center justify-between">
            ...
            <StaggerItem>
              <div className="bg-white dark:bg-[#121915] border border-[#E2E8F0] dark:border-[#1E2C24] rounded-2xl p-6 space-y-3 shadow-sm hover:border-sky-500/40 transition-colors">
                <div className="flex items-center justify-between">
        ...
        {/* 4. FINAL STORYTELLING CTA */}
        <ScrollReveal variant="fade-up" className="bg-emerald-950 text-white rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-xl relative overflow-hidden">
